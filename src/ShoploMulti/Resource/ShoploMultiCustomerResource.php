...
class ShoploMultiCustomerResource
{
    ...
    public function getCustomersUrl($id = 0, $parameters = [])
    {
        ...
        return $id ? '/v1/public/customers/' . $id . $filterParams : '/v1/public/customers' . $filterParams;
    }

    public function getCustomer($id, $parameters = [])
    {
        return $this->shoploMultiClient->get(ShoploMultiCustomer::class, $this->getCustomersUrl($id, $parameters), $parameters);
    }

    public function getCustomers($parameters = [])
    {
        return $this->shoploMultiClient->get(ShoploMultiCustomersCollection::class, $this->getCustomersUrl(0, $parameters), $parameters);
    }
    ...
    public function getCount($parameters = [])
    {
        ...
        $customersCollection = $this->shoploMultiClient->get(ShoploMultiCustomersCollection::class, $this->getCustomersUrl(0, $parameters), $parameters);
