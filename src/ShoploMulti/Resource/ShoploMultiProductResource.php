...
class ShoploMultiProductResource
{
    ...
    {
        return $variantId ? '/v1/public/products/' . $id . '/variants/'. $variantId : '/v1/public/products/' . $id . '/variants';
    }
    ...
    {
        return $this->shoploMultiClient->get(ShoploMultiProduct::class, $this->getProductVariantsUrl($id, $variantId));
    }

    public function getProductImages($id)
    {
        return $this->shoploMultiClient->get(ShoploMultiProductImagesCollection::class, $this->getProductImagesUrl($id));
    }

    public function getProductVariants($id)
    {
        return $this->shoploMultiClient->get(ShoploMultiProductVariantsCollection::class, $this->getProductVariantsUrl($id));
    }

    public function getProductVariantsProperties($id)
    {
        return $this->shoploMultiClient->get(ShoploMultiProductVariantsPropertiesCollection::class, $this->getProductVariantsPropertiesUrl($id));
    }
